...
class ContactBlock extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ContactBlock();
}

class _ContactBlock extends State<ContactBlock> {
  bool canLogin = false;
        ...
        children: [
          ...
          Container(
            decoration: const BoxDecoration(
                border: Border(
                    top: BorderSide(color: Color(0xFFE6E6EF), width: 2))),
            child: Accordion(
                paddingListTop: 0,
                paddingListBottom: 0,
                paddingListHorizontal: 0,
                headerBorderRadius: 0,
                rightIcon: SvgPicture.asset('assets/bottom-row.svg',
