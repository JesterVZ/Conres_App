  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const Text("Вход в качестве логина", style: TextStyle(fontSize: 16),),
              const Spacer(),
              Switch(value: isLogin, onChanged:(value){
                setState(() {
                  isLogin = value;
                });
        ...
        Text("Отправка уведомлений", style: TextStyle(fontSize: 15, color: colorGrayClaim)),
        Container(
          margin: EdgeInsets.only(top: 12, bottom: 12),
          decoration: BoxDecoration(
            color: Color.fromARGB(108, 229, 232, 237),
          ...
          child: Row(
            children: [
              ...
              const Text("Заявления", style: TextStyle(fontSize: 16),),
              const Spacer(),
              Switch(value: isLogin, onChanged:(value){
                setState(() {
                  isLogin = value;
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const Text("Обращения", style: TextStyle(fontSize: 16),),
              const Spacer(),
              Switch(value: isLogin, onChanged:(value){
                setState(() {
                  isLogin = value;
