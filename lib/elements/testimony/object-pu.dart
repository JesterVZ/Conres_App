          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Адрес объекта:", style: TextStyle(color: colorGrayClaim, fontSize: 15)),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    onPressed: (){
                      showDialog(context: context, builder: (BuildContext context) => ObjectPuDialog(title: "Редактировать объект", function: (){},));
                    }, 
                    style: ElevatedButton.styleFrom(primary: messageColor),
                    child: Text("Редактировать", style: TextStyle(color: colorMain))),
                  ),
                  const Spacer(),
                  Container(
                    height: 50,
                    ...
                    child: ElevatedButton(
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => PageTU()));
                    }, 
                    style: ElevatedButton.styleFrom(primary: messageColor),
                    child: Text("Подробнее", style: TextStyle(color: colorMain))),
                  ),
                ],
              ),
            )
