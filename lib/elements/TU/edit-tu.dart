...
class _EditPuPage extends State<EditPuPage> {
  ...
  List dropdownTypeList = [{'label': 'Электроэнергия', 'value': '1'}];
  List dropdownTariffList = [{'label': 'Двухтарифный', 'value': '2'}, {'label': 'Однотарифный', 'value': '3'}];
  bool isLoaded = false;
  ...
  void initState() {
    for (int i = 0; i < widget.TuPoints.length; i++) {
      dropdownPointsList.add(
          {'id': widget.TuPoints[i].point_id, 'label': widget.TuPoints[i].name, 'value': widget.TuPoints[i].name});
    }
                      ...
                      child: Padding(
                          ...
                          child: Form(
                                ...
                                children: [
                                    ...
                                    child: Flex(
                                      ...
                                      children: [
                                        ...
                                        itemBuilder: (context, int index) {
                                          return ListElement(text: selectedPoints.values.elementAt(index));
                                        }))
                                      ],
                                    )
                                  ...
                                  Visibility(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Добавленная точка учета", style: labelTextStyle),
                                        ListElement(text: newTuNameController.text)
                                        ])),
                              ...
                              btnOk: DefaultButton(
                                isGetPadding: false,
                                onPressed: () {
                                  if (_formNewTUKey.currentState!.validate()) {
                                    newTu ??= TuModel();
                                    setState(() {
                                      newTu!.name = newTuNameController.text;
                                      newTu!.address = newTuAddressController.text;
                                      newTu!.number = newTuNameController.text;
                                    });
                              ...
                              body: Container(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: DefaultInput(
                                                ...
                                                validatorText:
                                                    "Введите номер ТУ",
                                                controller: newTuNumberController),
                                          ),
                                          Container(
                                            margin: EdgeInsets.only(bottom: 15),
                                            child: DefaultInput(
                                                ...
                                                controller: newTuNameController),
                                          ),
                                          DefaultInput(
                                              labelText: "Адрес ТУ",
                                              ...
                                              controller: newTuAddressController),
                                        ]),
                                  )),
                            ).show();
                                  ...
                                  Container(
                                    ...
                                    child: DefaultInput(
                                        ...
                                        validatorText: "Введите множитель показаний"),
                                  ),
                                  Container(
                                    margin: EdgeInsets.only(bottom: 15),
                                    child: DefaultButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          for(int i = 0; i < selectedPoints.length; i++){
                                            newTuIdList.add(selectedPoints.keys.elementAt(i));
                                          }
                                          if(_formKey.currentState!.validate()){
                                            profileBloc!.editPuFromTu(
                                              ...
                                              widget.currentMeter.pu_type_id!, 
                                              "2", //даухтарифный
      ...
      dynamic message = MessageSend(
                    ...
                    data: PuEditNew(
                      ...
                      meterInfo: MeterInfo(
                        ...
                        measureMultipler: state.editPuFromTuData!['meter_info']['measure_multipler'],
                        ),
