...
class ExpansionTileOwm extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionTileOwm({Key? key,
  ...
  @override
  State<ExpansionTileOwm> createState() => ExpansionTileOwnState();
}

class ExpansionTileOwnState extends State<ExpansionTileOwm> with SingleTickerProviderStateMixin {
